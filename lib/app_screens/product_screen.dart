...
class ProductScreen extends StatefulWidget {
  ...
  ProductScreen({super.key, required this.item, required this.coffeeType});
...
class _ProductScreenState extends State<ProductScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(
        padding:
            const EdgeInsets.only(left: 15, right: 10, bottom: 20, top: 20),
        child: Column(
                  ...
                  Flexible(
                    child: ElevatedButton(
                        ...
                        style: ButtonStyle(
                            ...
                            minimumSize:
                                MaterialStateProperty.all(Size(280, 45)),
                            backgroundColor:
                                MaterialStateProperty.all(secondaryColor)),
                        child: Text(
                          'BUY NOW',
